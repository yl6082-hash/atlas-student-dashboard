globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/query-D8Wk3mvj.js","assets/page-C7_IFeHC.js","assets/page-H2iQLU_L.js","assets/layout-segment-context-DDaT-RoU.js","assets/router-D1GSndrG.js"];
...
function getDraftSecret() {
	return "720f41ae-deb1-4377-9de0-a9dc6b45b084";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "7a253eaa-1700-4f98-927d-b73ed244c895";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "7a253eaa-1700-4f98-927d-b73ed244c895") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "7a253eaa-1700-4f98-927d-b73ed244c895",
		rootBoundaryId
	});
}
/**
...
var schoolSources = sqliteTable("school_sources", {
...
*/
var intelligenceItems = sqliteTable("intelligence_items", {
	id: integer("id").primaryKey({ autoIncrement: true }),
	schoolSlug: text("school_slug").notNull(),
	schoolName: text("school_name").notNull(),
...
//#endregion
//#region app/api/advisor/intelligence/[id]/route.ts
var route_exports$3 = /* @__PURE__ */ __exportAll({ PATCH: () => PATCH });
async function PATCH(request, context) {
	...
	if (!Number.isInteger(itemId) || !["verified", "returned"].includes(body.decision ?? "")) return Response.json({ error: "无效的审核请求。" }, { status: 400 });
...
async function generateMetadata() {
	...
	const baseUrl = `${requestHeaders.get("x-forwarded-proto") ?? (host.includes("localhost") ? "http" : "https")}://${host}`;
	return {
...
var page_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "bf65f9574435", "default");
//#endregion
//#region app/api/advisor/intelligence/route.ts
...
async function GET$1() {
	if (!await getChatGPTUser()) return Response.json({ error: "顾问登录后才能查看审核队列。" }, { status: 401 });
	const items = await getDb().select().from(intelligenceItems).orderBy(desc(intelligenceItems.observedAt), desc(intelligenceItems.id));
...
async function POST$2(request) {
	...
	for (const field of required) if (typeof payload[field] !== "string" || !payload[field].trim()) return Response.json({ error: `缺少字段：${field}` }, { status: 400 });
	const [item] = await getDb().insert(intelligenceItems).values({
		schoolSlug: payload.schoolSlug,
		schoolName: payload.schoolName,
		schoolCode: payload.schoolCode,
		schoolAccent: payload.schoolAccent,
...
//#endregion
//#region data/official-sources.ts
...
var officialSources = [
	...
	},
	{
		...
		schoolCode: "UCD",
		schoolAccent: "#1f5a99",
		label: "UC Davis First-year Requirements",
		url: "https://www.ucdavis.edu/admissions/undergraduate/first-year/requirements",
		kind: "招生要求"
	},
	{
		schoolSlug: "nyu",
	...
	},
	{
		...
		schoolCode: "CMU",
		schoolAccent: "#c41230",
		label: "CMU Undergraduate Admission",
	...
	},
	{
		...
		schoolCode: "SU",
		schoolAccent: "#8c1515",
		label: "Stanford First-Year Application",
		url: "https://admission.stanford.edu/apply/first-year/",
		kind: "招生要求"
	}
];
//#endregion
//#region app/api/advisor/monitor/route.ts
...
async function POST$1() {
	...
	for (const source of officialSources) try {
		...
		await db.update(schoolSources).set({
			lastFingerprint: nextFingerprint,
			lastCheckedAt: now
...
//#endregion
//#region app/api/intelligence/route.ts
...
async function GET() {
	try {
		const rows = await getDb().select().from(intelligenceItems).where(eq(intelligenceItems.reviewStatus, "verified")).orderBy(desc(intelligenceItems.observedAt), desc(intelligenceItems.id)).limit(12);
...
var routes = [
	{
		...
		ids: {
			"route": "route:/api/advisor/intelligence/:id",
			"page": null,
			"routeHandler": "route-handler:/api/advisor/intelligence/:id",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/advisor/intelligence/:id",
		patternParts: [
			"api",
			"advisor",
			"intelligence",
	...
	},
	{
		...
		ids: {
			"route": "route:/advisor/review",
			"page": "page:/advisor/review",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
		...
		pattern: "/advisor/review",
		patternParts: ["advisor", "review"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: page_exports,
	...
	},
	{
		...
		ids: {
			"route": "route:/api/advisor/intelligence",
			"page": null,
			"routeHandler": "route-handler:/api/advisor/intelligence",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/advisor/intelligence",
		patternParts: [
			"api",
			"advisor",
			"intelligence"
	...
	},
	{
		...
		ids: {
			"route": "route:/api/advisor/monitor",
			"page": null,
			"routeHandler": "route-handler:/api/advisor/monitor",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/advisor/monitor",
		patternParts: [
			"api",
			"advisor",
			"monitor"
	...
	},
	{
		...
		ids: {
			"route": "route:/api/intelligence",
			"page": null,
			"routeHandler": "route-handler:/api/intelligence",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		...
		layouts: [layout_exports],
		routeSegments: ["api", "intelligence"],
		templateTreePositions: [],
		layoutTreePositions: [0],
		templates: [],
		errors: [null],
