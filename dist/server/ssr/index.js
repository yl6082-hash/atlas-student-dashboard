...
var client_references_default = {
	"6efdf509a785": async () => {
		const m = await import("./assets/page-DXjerG_L.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	...
	"97e23c8fc95f": async () => {
		const m = await import("./assets/error-boundary-C2ICxBNv.js");
		return {
			get "ErrorBoundary"() {
	...
	"bf65f9574435": async () => {
		const m = await import("./assets/page-xRQn1u4O.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"d7d8178d8913": async () => {
		const m = await import("./assets/layout-segment-context-9ltsxReC.js");
